...
save = True
if save is True:
    with open('eval_set_activation2_10_runs_training_corrected.pkl', 'wb') as f:
...
with open('eval_set_activation2_10_runs_training_corrected.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
...
plt.figure()
plt.bar([2,3,4,5,6,7],arr.mean(axis=0), align='center' ,width=0.3, color = 'orange', edgecolor = 'black', capsize=7, ecolor = 'black', linewidth = 2, label='with activation')
...
plt.bar([2+0.3,3+0.3,4+0.3,5+0.3,6+0.3,7+0.3],arr.mean(axis=0), align='center' ,width=0.3, color = 'blue', edgecolor = 'black', capsize=7, ecolor = 'black', linewidth = 2, label='no activation')
