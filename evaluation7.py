# just a rerun of evaluation 6 to make sure the results are correct
# learn puzzles 1,...,k and get the seed for every puzzle.
...
if save is True:
    if CONDITION == 'curious':
        with open('curious_y_output_e7_1e5_2.pkl', 'wb') as f:
    ...
    if CONDITION == 'not_curious':
        with open('not_curious_y_output_e7_1e5_2.pkl', 'wb') as f:
            pickle.dump([selection_sequence,training_set_input,training_set_output, global_out_list, global_H_list], f, pickle.HIGHEST_PROTOCOL)
